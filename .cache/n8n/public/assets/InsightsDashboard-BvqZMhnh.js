const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-4Vl-4bws.js","assets/index-HDYArLT1.js","assets/index-B4xpaMaK.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-Dxn2bjBB.js","assets/chartjs.utils-CC0SyVUG.js","assets/InsightsSummary-CTzqNpAf.js","assets/InsightsSummary-DzGQpM5h.css","assets/index-CAyQE60i.js","assets/InsightsChartFailed-Cm5FrmfQ.js","assets/InsightsChartFailureRate-Ci-cBou0.js","assets/InsightsChartTimeSaved-CMBBA9I4.js","assets/InsightsChartAverageRuntime-Cr7taDDn.js","assets/InsightsTableWorkflows-DgCECSSh.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cu as useModel, gb as useInsightsStore, r as ref, gx as UNLICENSED_TIME_RANGE, gj as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, D as renderList, m as unref, fo as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, fp as N8nSelect, q as computed, c as useI18n, j as createVNode, bf as N8nText, bh as N8nButton, gy as ElDialog, a6 as usePageRedirectionHelper, _ as _export_sfc, dk as defineAsyncComponent, X as watch, o as onMounted, a4 as useDocumentTitle, h as resolveComponent, n as normalizeClass, b7 as resolveDynamicComponent, ao as __vitePreload, ag as useTelemetry, gz as TELEMETRY_TIME_RANGE } from "./index-HDYArLT1.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-4Vl-4bws.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-Dxn2bjBB.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Cm5FrmfQ.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-Ci-cBou0.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CMBBA9I4.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-Cr7taDDn.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DgCECSSh.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
