const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-Bd2BI_OU.js","assets/index-HDYArLT1.js","assets/index-B4xpaMaK.css","assets/NodeCreator-Cp8Apzva.css"])))=>i.map(i=>d[i]);
import { cA as useNodeCreatorStore, bz as useNodeTypesStore, q as computed, c as useI18n, Q as useWorkflowsStore, gR as MANUAL_TRIGGER_NODE_TYPE, gS as CHAIN_LLM_LANGCHAIN_NODE_TYPE, by as NodeConnectionTypes, cH as CHAT_TRIGGER_NODE_TYPE, gT as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, gU as OPEN_AI_NODE_TYPE, gV as SPLIT_IN_BATCHES_NODE_TYPE, gW as NO_OP_NODE_TYPE, gX as WEBHOOK_NODE_TYPE, gY as SCHEDULE_TRIGGER_NODE_TYPE, gZ as transformNodeType, aP as useExternalHooks, $ as useCanvasStore, g_ as AI_CATEGORY_LANGUAGE_MODELS, g$ as QA_CHAIN_NODE_TYPE, h0 as AGENT_NODE_TYPE, h1 as BASIC_CHAIN_NODE_TYPE, h2 as OPEN_AI_ASSISTANT_NODE_TYPE, ay as STICKY_NODE_TYPE, h3 as sortNodeCreateElements, h4 as TRIGGER_NODE_CREATOR_VIEW, cB as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, H as useUIStore, r as ref, bU as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bQ as KeyboardShortcutTooltip, dk as defineAsyncComponent, cN as Suspense, F as Fragment, ao as __vitePreload, h5 as getMidCanvasPosition, h6 as DEFAULT_STICKY_WIDTH, h7 as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-HDYArLT1.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-Bd2BI_OU.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
