const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-BRAsiSnM.js","assets/index-HDYArLT1.js","assets/index-B4xpaMaK.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, as as useNDVStore, r as ref, gO as useElementSize, q as computed, fc as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, dk as defineAsyncComponent, cN as Suspense, gJ as TextWithHighlights, n as normalizeClass, gK as MappingPill, gf as Draggable, ao as __vitePreload, v as shorten, gN as getMappedExpression, gP as isString, gQ as nonExistingJsonPath, aP as useExternalHooks, ag as useTelemetry, _ as _export_sfc } from "./index-HDYArLT1.js";
import { t as VueJsonPretty } from "./RunData-u5uBr_cv.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-BRAsiSnM.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
